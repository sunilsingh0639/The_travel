...
xhttp.onload = function () {
    ...
    Array.from(json_records).forEach(function(element){
        applicationList.add({
            id: '<a  class="fw-medium link-primary">#VZ'+element.id+'</a>',
    ...
    applicationList.remove("id", `<a  class="fw-medium link-primary">#VZ001</a>`);
}
    ...
    form.addEventListener('submit', function (event) {
        if (!form.checkValidity()) {
            ...
            if (companyField.value !== "" &&
                ...
                applicationList.add({
                    id: '<a  class="fw-medium link-primary">#VZ'+count+'</a>',
                    company: '<div class="d-flex align-items-center">\
                    <div class="flex-shrink-0">\
        ...
        Swal.fire({
            ...
            if (result.value) {
                for (i = 0; i < ids_array.length; i++) {
                    applicationList.remove("id", `<a  class="fw-medium link-primary">` + ids_array[i] +`</a>`);
                }
