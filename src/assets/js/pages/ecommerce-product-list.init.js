			...
			},
			{
				...
				formatter: (function (cell, row) {
					...
					return gridjs.html('<div class="dropdown">' +
						...
						'<li><a class="dropdown-item remove-list"  data-id=' + x + ' data-bs-toggle="modal" data-bs-target="#removeItemModal"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>' +
						'</ul>' +
						'</div>');
				})
			}
			...
			},
			{
				...
				formatter: (function (cell, row) {
					return gridjs.html('<div class="dropdown">' +
						...
						'<li class="dropdown-divider"></li>' +
						'<li><a class="dropdown-item remove-list"  data-id=' + row._cells[0].data + ' data-bs-toggle="modal" data-bs-target="#removeItemModal"><i class="ri-delete-bin-fill align-bottom me-2 text-muted"></i> Delete</a></li>' +
						'</ul>' +
						'</div>');
				})
			}
